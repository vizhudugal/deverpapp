...
exports.fetch_quality_parameter_range_dao_fn = function(quality_parameter, res, result){
  ...
  // .innerJoin('md_quality_parameter as t4','t4.quality_parameter_id','t2.quality_parameter_id')
  .innerJoin('md_procurement_item as t3','t3.item_id','t1.item_id')
  .where({'t2.quality_parameter_id' :quality_parameter.quality_parameter_id},{'t3.item_id':quality_parameter.item_id})
