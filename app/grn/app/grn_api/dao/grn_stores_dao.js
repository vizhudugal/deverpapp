...
exports.grn_stores_dao_fn = function(req,result){
          ...
          .select('T1.item_name','T1.item_id','T1.item_specification1','T2.supplier_name','T3.*','T4.item_quantity','T4.container_quantity','T4.unit_of_measure_id','T4.container_type_id','T4.status','T4.po_number','T4.po_date')
          .where({'T4.status':'item_received'})
          .then(function(rows){
